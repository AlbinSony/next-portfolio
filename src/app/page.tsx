      ...
      <div className="flex flex-col items-start px-6 md:px-12 pt-4 md:pt-6 space-y-8 md:space-y-12 max-w-3xl w-full mx-auto">
        ...
        <div>
          <div className="flex items-center gap-6 mb-4">
            ...
            <div>
              <h1 className={`text-3xl md:text-4xl font-medium gap-2 dark:text-neutral-200 ${geistMono.className}`}>Albin Sony</h1>
          ...
          <div className="mt-5 space-y-4">
            ...
            <a
              href="https://drive.google.com/file/d/121V5oNb92f5DCbKIGZSW1JlDwGHXwGBA/view?usp=sharing"
